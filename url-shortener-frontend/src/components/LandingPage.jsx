...
const LandingPage = () => {
    ...
    useEffect(() => {
        fetch(`${import.meta.env.VITE_BACKEND_URL}/api/auth/public/login`, {
            method: "POST",
            mode: "no-cors",
        });
    }, []);
    ...
    return (
        <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    <motion.h1
                        ...
                        className='font-bold font-roboto text-slate-800 md:text-5xl text-3xl
                     md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full'>
                        Linklytics Simplifies Url Shortening.
                    </motion.h1>
            ...
            <div className='sm:pt-12 pt-7'>
                <p className='text-slate-800 font-roboto font-bold lg:w-[60%] md:w-[70%] 
                sm:w-[80%] mx-auto text-3xl text-center'>
